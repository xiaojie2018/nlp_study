...
from data_loader.mrc_data_processor import Conll03Processor, MSRAProcessor, Onto4ZhProcessor, Onto5EngProcessor, \
    GeniaProcessor, ACE2004Processor, ACE2005Processor, ResumeZhProcessor
...
def args_parser():
    ...
    parser.add_argument("--data_sign", type=str, default="zh_msra")
    ...
    args.data_dir = '../data_preprocess/data_test'
    args.bert_model = "E:\\nlp_tools\\bert_models\\bert-base-chinese"
    args.task_name = "zh_msra"
...
def train(model, optimizer, sheduler,  train_dataloader, dev_dataloader, test_dataloader, config, device, n_gpu, label_list):
    nb_tr_steps = 0 
    tr_loss = 0 
