...
def flat_ner_performance(pred_start, pred_end, pred_span, gold_start, gold_end, gold_span, ner_cate, label_lst, threshold=0.5, dims=2):
    ...
    if dims == 1:
        ...
        for pred_start_item, pred_end_item, pred_span_item, gold_start_item, gold_end_item, gold_span_item, ner_cate_item \
                in zip(pred_start, pred_end, pred_span, gold_start, gold_end, gold_span, ner_cate):
...
def nested_ner_performance(pred_start, pred_end, pred_span, gold_start, gold_end, gold_span, ner_cate, label_lst, threshold=0.5, dims=2):
    ...
    if dims == 1:
        ...
        for pred_start_item, pred_end_item, pred_span_item, gold_start_item, gold_end_item, gold_span_item, ner_cate_item \
            ...
            pred_span_triple, gold_span_triple = nested_ner_performance(pred_start_item, pred_end_item, pred_span_item,
