...
def generate_query_ner_dataset(source_file_path, dump_file_path, entity_sign="nested", dataset_name=None, query_sign="default"):
    """
    Args:
...
def transform_examples_to_qa_features(query_map, entity_labels, data_instances, entity_sign="nested"):
    ...
    Args:
        ...
        data_instance : nested: [{context:"", label:{label1:["1,2","7,8",...], label2:["6,8", ..], ... }}, {}, {}, ... ]
                        flat : [([w1, w2, ..], [l1, l2, ...]), ([], []), ....]
    """ 
    mrc_ner_dataset = []
