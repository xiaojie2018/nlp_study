...
from .utils import MODEL_CLASSES, set_seed, compute_metrics
from .model import BertDialogueIntentClassification
import numpy as np
import torch
...
class Trainer(object):
    def __init__(self, args, train_dataset=None, dev_dataset=None, test_dataset=None):
        ...
        self.model_class = BertDialogueIntentClassification
