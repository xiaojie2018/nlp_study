...
class BertForCnnGramClassification(BertPreTrainedModel):
    
    def __init__(self, config):
        super(BertForCnnGramClassification, self).__init__(config)
...
# -------------------------------------------------------------------------------------------
# BertForCnnGramExtractor 
# -------------------------------------------------------------------------------------------
class BertForCnnGramExtractor(BertForCnnGramClassification):
