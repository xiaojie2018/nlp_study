...
# bert2span
def bert2span_decoder(args, data_loader, dataset, model, test_input_refactor, pred_arranger, mode, stem_flag=False):
...
# bert2tag
def bert2tag_decoder(args, data_loader, dataset, model, test_input_refactor, pred_arranger, mode, stem_flag=False):
    logging.info('Start Generating Keyphrases for %s ... \n'%mode)
    test_time = utils.Timer()
...
# Bert2Chunk
def bert2chunk_decoder(args, data_loader, dataset, model, test_input_refactor, pred_arranger, mode, stem_flag=False):
    logging.info('Start Generating Keyphrases for %s ... \n'%mode)
    test_time = utils.Timer()
    if args.dataset_class == "kp20k":stem_flag = True
...
def bert2rank_decoder(args, data_loader, dataset, model, test_input_refactor, pred_arranger, mode, stem_flag=False):
    logging.info('Start Generating Keyphrases for %s ... \n'%mode)
    test_time = utils.Timer()
    if args.dataset_class == "kp20k":stem_flag = True
